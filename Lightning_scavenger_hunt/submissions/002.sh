...
# Your script should echo the last updated time as a unix timestamp.

node="0325ecd6d2d8739681e2f7644f4221ed942b76d6b7825d4e730671ad17fb0d50e5"
channel_id="2811451232288768"

# This lncli command allows the script to run against signet nodes for testing purposes.
...
node_data=$($lncli getchaninfo --chan_id="$channel_id")
fee_base_msat=$(echo "$node_data" | jq -r '.node2_policy.fee_base_msat')
echo $fee_base_msat